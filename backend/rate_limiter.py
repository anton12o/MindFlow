...
backup_limiter = RateLimiter(max_requests=5, window_seconds=60)
attachments_limiter = RateLimiter(max_requests=10, window_seconds=60)
crud_limiter = RateLimiter(max_requests=300, window_seconds=60)
